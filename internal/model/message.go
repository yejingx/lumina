...
type WorkflowResp struct {
	...
	RawContent  string  `json:"raw_content,omitempty" gorm:"type:text"`
	Confidence  float32 `json:"confidence,omitempty" gorm:"type:float"`
	Match       bool    `json:"match,omitempty" gorm:"type:bool"`
