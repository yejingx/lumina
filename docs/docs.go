...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/camera/{camera_id}/preview": {
            "put": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "预览任务",
                        "schema": {
                            "$ref": "#/definitions/dao.PreviewTask"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "获取成功",
                        "schema": {
                            "$ref": "#/definitions/dao.ListPreviewTasksResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
